...
class diff_CSDI(nn.Module):
    ...
    def forward(self, x, cond_info, diffusion_step): # cond_info is side information
        B, inputdim, K, L = x.shape #conditional: (B,2,K,L), 2 contains "cond_obs" and "noisy_data"; unconditional: (B,1,K,L)
